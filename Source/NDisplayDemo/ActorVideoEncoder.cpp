...
{
	Super::BeginPlay();
	UE_LOG(LogTemp,Display,TEXT("Recorder beginplay"))
...
{
	// GEngine->AddOnScreenDebugMessage(-1, 1.f, FColor::Red, TEXT("Callback"));
	// UE_LOG(LogTemp,Display,TEXT("Callback"))
	// FString path = "C:\\Users\\Suriba\\Documents\\Unreal Projects\\NDisplayDemo\\Dump";
	// path.AppendInt(FrameIndex);
	// // FViewport * GetActiveViewport();
	// // MainViewport->GetRenderTargetTexture();
	// FrameIndex++;
	// SaveFTexture2DRHIRefToPNG(FrameBuffer,path);
	// if (VideoEncoder)
	// {
